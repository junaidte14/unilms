    ...
    <?php if ( have_posts() ) : ?>
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <header class="page-header">
                <h1 class="page-title"><?php _e('Attendances', 'unilms');?></h1>
            </header>
            <table>
                ...
                <?php while ( have_posts() ) : the_post(); ?>
                    ...
                    <tr>
                        ...
                        <?php the_title(); ?></a></td>
                        <td style="text-align: center;"><?php echo esc_html( get_the_title ( get_post_meta( get_the_ID(), 'attendance_course', true ) ) ); ?></td>
                        <td style="text-align: center;"><?php echo esc_html( get_the_title ( get_post_meta( get_the_ID(), 'attendance_class', true ) ) ); ?></td>
                    </tr>
                <?php endwhile; ?>
