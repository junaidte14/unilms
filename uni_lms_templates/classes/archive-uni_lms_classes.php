                ...
                <table>
                    ...
                    <?php while ( have_posts() ) : the_post(); ?>
                        ...
                        <tr>
                            ...
                            <?php the_title(); ?></a></td>
                            <td><?php echo esc_html( get_post_meta( get_the_ID(), 'class_semester', true ) ); ?></td>
                            <td><?php echo esc_html( get_post_meta( get_the_ID(), 'class_session', true ) ); ?></td>
                            <td><?php echo esc_html( get_post_meta( get_the_ID(), 'class_fall_spring', true ) ); ?></td>
                        </tr>
                    <?php endwhile; ?>
