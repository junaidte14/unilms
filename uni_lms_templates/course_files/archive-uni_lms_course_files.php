                ...
                <header class="page-header alignwide">
                    <div class="codoswp-container">
                        <div class="page-title">
                            <h1><?php _e('Course Files', 'unilms');?></h1>
                        </div>
                    </div>
                </header>
                <table>
                    ...
                    <?php while ( have_posts() ) : the_post(); ?>
                        <tr>
                            ...
                            <?php the_title(); ?></a></td>
                            <td><?php echo get_the_title( get_post_meta( get_the_ID(), 'course_file_course', true ) ); ?></td>
                            <td><?php echo get_the_title( get_post_meta( get_the_ID(), 'course_file_class', true ) ); ?></td>
                        </tr>
                    <?php endwhile; ?>
                </table>
                <?php global $wp_query;
